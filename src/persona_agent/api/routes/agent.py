...
async def list_agents(agent_factory=Depends(get_agent_factory)):
...
async def get_agent(agent_id: str, agent_factory=Depends(get_agent_factory)):
...
async def delete_agent(agent_id: str, agent_factory=Depends(get_agent_factory)):
    """Delete an agent."""
