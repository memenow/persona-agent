...
from persona_agent.api.models import (
...
async def list_sessions(agent_factory=Depends(get_agent_factory)):
...
async def get_session(session_id: str, agent_factory=Depends(get_agent_factory)):
...
async def delete_session(session_id: str, agent_factory=Depends(get_agent_factory)):
    """Delete a session."""
...
async def get_session_messages(
    session_id: str, agent_factory=Depends(get_agent_factory)
):
