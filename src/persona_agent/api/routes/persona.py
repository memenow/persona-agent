...
async def list_personas(persona_manager=Depends(get_persona_manager)):
...
async def get_persona(persona_id: str, persona_manager=Depends(get_persona_manager)):
...
async def upload_persona(
    file: UploadFile = File(...), persona_manager=Depends(get_persona_manager)
):
