...
class CreatePersonaRequest(BaseModel):
    ...
    personal_background: dict[str, Any] | None = Field(
        default=None, description="Personal background information"
    )
    language_style: dict[str, Any] | None = Field(
        default=None, description="Language style characteristics"
    )
    knowledge_domains: dict[str, Any] | None = Field(
        default=None, description="Knowledge domains and expertise"
    )
    interaction_samples: list[dict[str, Any]] | None = Field(
        default=None, description="Sample interactions"
    )
...
class UpdatePersonaRequest(BaseModel):
    ...
    name: str | None = Field(default=None, description="Name of the persona")
    description: str | None = Field(
        default=None, description="Description of the persona"
    )
    personal_background: dict[str, Any] | None = Field(
        default=None, description="Personal background information"
    )
...
class SendMessageResponse(BaseModel):
    ...
    error_details: str | None = Field(
        default=None, description="Detailed error information if available"
    )
...
class ToolResponse(BaseModel):
    ...
    service_name: str = Field(
        ..., description="Name of the service providing this tool"
    )
...
class ToolExecuteRequest(BaseModel):
    ...
    session_id: str | None = Field(
        default=None,
        description="Optional session ID to associate with this tool execution",
    )
